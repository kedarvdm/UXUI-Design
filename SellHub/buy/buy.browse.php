<?php
	...
	$searchedproduct=$_GET["searchedproduct"];
		...
		<div class="row">
			...
			<div class="col-sm-8">
				<div class="row">
					<form action="buy.browse.php" method="get">
						...
						<div class="col-sm-8  form-group">
							<div class="input-group">
							  <input type="text" id="searchproduct" name="searchedproduct" class="form-control autocomplete" aria-label="Text input" placeholder="Search Product">
							  <div class="input-group-btn">
				...
				<?php
					...
					FROM product p inner join categories c ON p.categoryid= c.id 
					...
					{
							$query = $query ." AND pt.type like '%".$searchedproduct."%'";
					}
					if(!empty($searchedcategory))
					{
							$query = $query ." AND c.name like '%".$searchedcategory."%'";
					}
					...
					{
						echo '<div class="card card-block bg-inverse">';
						echo '  <h3 class="card-title turnred">Product Unavailable!!</h3>';
						echo '  <p class="card-text">We are sorry, this product is not available at the moment.</p>';
						echo '  <p class="card-text">Please look for another product that you might like.</p>';
						echo '</div>';
					}
				?>
				</div>
